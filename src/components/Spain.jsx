...
const Tours = () => {
    return (
        <>
            <section className="offer-spain">
                <div className="x"><span>X</span></div>
                <div className="title">
                    <h1>Hiszpania</h1>
                    <h2>Siesta, fiesta i maniana</h2>
                    <h4>I ta muzyka czarnosrebrna, srebrnozłota nagle wybucha i wypełnia noc po brzegi, I bez flamenco nie zrozumiesz Don Kichota, Garci De Lorci i Lope de Vegi.<span>Wojciech Młynarski</span></h4>
                </div>
